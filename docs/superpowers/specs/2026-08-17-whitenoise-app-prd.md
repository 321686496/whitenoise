...
| 成就 ID    | 名称    | 触发条件               | 展示 |
| -------- | ----- | ------------------ | -- |
| ACH\_001 | 初次入眠  | 首次使用定时器完成一次播放      | 徽章 |
| ACH\_002 | 连续七天  | 连续 7 天使用 App       | 徽章 |
| ACH\_003 | 声音调音师 | 创建 5 个自定义场景        | 徽章 |
| ACH\_004 | 分享达人  | 成功邀请 3 位好友         | 徽章 |
| ACH\_005 | 百日坚持  | 累计使用 100 天         | 徽章 |
| ACH\_006 | 午夜电台  | 在 22:00-02:00 期间使用 | 徽章 |
| ACH\_007 | 混音大师  | 同时加载 6 路音轨         | 徽章 |
| ACH\_008 | 审美家   | 切换过所有主题风格          | 徽章 |
